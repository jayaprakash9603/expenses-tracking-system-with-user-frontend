...
export const FETCH_PREVIOUS_EXPENSES_REQUEST = "FETCH_PREVIOUS_EXPENSES_REQUEST";
export const FETCH_PREVIOUS_EXPENSES_SUCCESS = "FETCH_PREVIOUS_EXPENSES_SUCCESS";
export const FETCH_PREVIOUS_EXPENSES_FAILURE = "FETCH_PREVIOUS_EXPENSES_FAILURE";